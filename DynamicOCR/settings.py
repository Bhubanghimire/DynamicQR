"""
Django settings for DynamicOCR project.
...
GEOIP_DATABASE = BASE_DIR / "geoip" / "GeoLite2-City.mmdb"
...
WSGI_APPLICATION = 'DynamicOCR.wsgi.application'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PAGINATION_CLASS': 'DynamicOCR.pagination.CustomPagination',
    'PAGE_SIZE': 10,
}
